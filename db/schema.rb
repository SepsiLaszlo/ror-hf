...
ActiveRecord::Schema.define(version: 2021_05_21_095417) do
  ...
  create_table "subject_applications", force: :cascade do |t|
    ...
    t.index ["user_id", "subject_id"], name: "index_subject_applications_on_user_id_and_subject_id", unique: true
